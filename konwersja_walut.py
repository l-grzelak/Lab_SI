...
#Funkcja wczytująca walutę z pliku .json
def load_currency(currency,begin,end):
...
rate1 = load_currency(currency1,date_from,date_to)
rate2 = load_currency(currency2,date_from,date_to)

#Tworzenie obiektów DataFrame ze słowników i ograniczenie danych
